...
#define RELAY D4
#define MOISTSEN A0                                                           //  Analog pin connected to water level sensor 
...
void loop() { 
  ...
  int l = analogRead(MOISTSEN);
  String moist = String(l);
  int a;
   String FireStatus = ""; 
 ...
 // String fireTemp = String(t) + String("Â°C");                                                     //convert integer temperature to string temperature
  ...
  Firebase.pushInt("Moisture_level",l);                               // setup path and push moisture value to database 
